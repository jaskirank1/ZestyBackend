...
const addToCart = async (req,res)=>{
    try{
        ...
        console.log(error);
        res.json({success:false,message:"Error in addToCart in cartController"});
    }
}
...
const removeFromCart = async (req,res)=>{
    try{
        ...
        console.log(error)
        res.json({success:false,message:"Error in removeFromCart in cartController"});
    }
}
...
const getCart = async (req,res)=>{
    try{
        ...
        console.log(error);
        res.json({success:false,message:"Error in getCart cartController"});
    }
}
